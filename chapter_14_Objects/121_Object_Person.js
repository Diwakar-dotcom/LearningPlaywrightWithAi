...
const user = {
    ...
    address: { // an object an have sub object
        houseNumber: "42B",
        street: "MG Road",
        ...
        postalCode: "560001",
        country: "India",
        coordinates: { // sub object --> can have sub object
            latitude: 12.9716,
            longitude: 77.5946,
        },
    },
    ...
    getIntroduction() { // Object can also have function - similar to class having property and methods
...
console.log(user.getIntroduction()); // calling function of object
console.log(user.getFullAddress());
console.log(user.address.city); // object --> sub Object --> property